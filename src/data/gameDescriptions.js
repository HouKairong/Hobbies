const gameDescriptions = {
  Wiedźmin: {
    world: "Avalon",
    why: "Nawiązuje do Avalonu, ponieważ oba światy opierają się na mrocznym, celtycko-arturiańskim klimacie, motywach rycerstwa, przepowiedni i magii przenikającej codzienność. Avalon w Wizard101 ma melancholijną, legendarną aurę – podobnie jak świat Geralta, gdzie mit miesza się z brutalną rzeczywistością, a dawne legendy wciąż wpływają na teraźniejszość.",
    protagonist: "Geralt z Rivii",
    antagonist: "Jacques de Aldersberg",
    location: "Kontynent (Kaer Morhen, Wyzima) 1270 rok",
    description:
  ...
  "Wiedźmin 2": {
    world: "Avalon",
    why: "Avalon pasuje tu jeszcze mocniej ze względu na polityczne intrygi, walkę frakcji i konflikt o władzę. W obu światach mamy rozbite struktury władzy, zakon rycerski, napięcia między rasami oraz motyw upadających ideałów. To bardziej „rycerska tragedia” niż klasyczne high fantasy.",
    protagonist: "Geralt z Rivii",
    antagonist: "Letho z Gulety",
    location:
      "Kontynent (Zamek La Valette, Flotsam, Dolina Pontaru, Loc Muinne) 1270 rok",
    description:
  ...
  "Wiedźmin 3": {
    ...
    why: "Avalon – przez arturiańskie motywy, Dzikiego Gonu i aurę pradawnej legendy. Grizzleheim – surowość natury, północny klimat, dzikość i pierwotne siły podobne do Skellige. Darkmoor – mroczna, gotycka atmosfera, upadłe zamki i poczucie nadciągającej katastrofy, które świetnie oddaje klimat dodatek Krew i Wino",
    protagonist: "Geralt z Rivii",
    antagonist: "Eredin, Dziki Gon, Pan Lusterko, Detlaff",
    location:
      "Kontynent (Biały Sad, Velen, Novigrad, Oxenfurt, Skellige, Kaer Morhen, Toussaint) 1272 rok",
    description:
  ...
  "Wiedźmin: Pożegnanie Białego Wilka": {
    world: "Avalon",
    why: "Avalon symbolizuje koniec legendy. To świat opowieści o bohaterach, którzy odchodzą, pozostawiając po sobie mit. Emocjonalny, niemal balladowy ton tego fanowskiego rozszerzenia idealnie wpisuje się w nostalgiczny charakter Avalonu.",
    protagonist: "Geralt z Rivii",
    antagonist: "Eredin, Dziki Gon",
    location: "Kontynent (Kaer Morhen) po 1272 roku",
    description:
  ...
  Gwint: {
    world: "Avalon",
    why: "Avalon, ponieważ świat ten w Wizard101 mocno opiera się na rycerskich frakcjach, herbach i idei honorowej rywalizacji. Gwint również bazuje na frakcjach, strategii i taktycznej „bitwie” symbolicznej, niemal turniejowej – jak pojedynek w sali zamkowej.",
    protagonist: "Gracz",
  ...
  "TES IV Oblivion": {
    world: "Avalon, Dragonspyre, Khrysalis",
    why: "Avalon – klasyczne, rycerskie high fantasy, cesarstwo i struktura władzy przypominają arturiańskie fundamenty. Dragonspyre – motyw Otchłani i demonicznych inwazji silnie koresponduje z apokaliptycznym charakterem tego świata. Khrysalis – Świat Sheogoratha z dodatku Shivering Isles ze swoim dziwnym krajobrazem i wielkimi robakami, bardzo przypomina Khrysalis",
    protagonist: "Bohater Kvatchu",
    antagonist: "Mehrunes Dagon",
    location: "Tamriel (Cyrodill), Otchłań, 433 rok Trzeciej Ery",
    description:
  ...
  "TES V Skyrim": {
    world: "Grizzleheim, Darkmoor",
    why: "Grizzleheim to oczywiste skojarzenie: nordycki klimat, mroźna kraina, motywy mitologiczne i pierwotne siły natury. Zarówno Skyrim, jak i Grizzleheim opierają się na surowej północy, legendach o pradawnych istotach i bohaterze wybranym przez przeznaczenie. Darkmoor zaś to pełen wampirów dodatek Dawnguard oraz mroczny wymiar Hermaeus Mora z dodatku Dragonborn",
    protagonist: "Smocze Dziecię",
    antagonist: "Alduin",
    location: "Tamriel (Skyrim), 201 rok Czwartej Ery",
    description:
  ...
  "Dark Souls 3": {
    world: "Dragonspyre",
    why: "Dragonspyre pasuje idealnie, bo to świat ruin, upadłej cywilizacji i dawnej potęgi, która spłonęła przez własną pychę. W obu przypadkach mamy motyw dogasającej ery – w Dark Souls 3 jest to Pierwszy Płomień, w Dragonspyre konsekwencja katastrofy wywołanej przez ambicję smoków. Architektura, lawowe krajobrazy i atmosfera końca świata tworzą niemal to samo poczucie: jesteś w miejscu, które już przegrało, a ty tylko decydujesz, jak zakończy się agonia.",
    protagonist: "Nierozpalony",
    antagonist: "Pontyfik Sulvyahn, Dusza Pogorzelisk",
    location: "Kraina Lothric",
    description:
  ...
  Bloodborne: {
    world: "Marleybone, Darkmoor",
    why: "Marleybone – gotycka, wiktoriańska estetyka, brukowane ulice, industrialny klimat i atmosfera kontrolowanej paranoi. Yharnam mógłby spokojnie istnieć jako mroczna dzielnica Marleybone. Darkmoor – kosmiczny horror i motyw przekraczania zakazanej wiedzy. Darkmoor ma aurę zepsutej magii i starożytnych tajemnic, co świetnie oddaje przejście Bloodborne od gotyckiego horroru do lovecraftowskiej grozy.",
    protagonist: "Łowca",
  ...
  "Elden Ring": {
    world: "Wizard City, Dragonspyre",
    why: "Wizard City – bo to świat fundamentów magii, szkół czarów i struktury porządku, który kiedyś był spójny, a potem został zachwiany. Elden Ring też zaczyna się od pęknięcia boskiego ładu. Dragonspyre – monumentalne ruiny, spalone krajobrazy, smoki i echo dawnej chwały. Ziemie Pomiędzy mają dokładnie tę samą skalę tragedii: coś wielkiego upadło, a ty poruszasz się po szczątkach boskiej architektury.",
    protagonist: "Zmatowiony",
    antagonist: "Radagon / Bestia Eldenu",
    location: "Ziemie Pomiędzy",
    description:
  ...
  "Sekiro: Shadows Die Twice": {
    world: "Mooshu",
    why: "Mooshu to najbardziej bezpośrednie skojarzenie – świat inspirowany kulturą Azji Wschodniej, duchowością, smokami i honorowym kodeksem. Zarówno Sekiro, jak i Mooshu opierają się na konflikcie między tradycją a zepsuciem władzy. Do tego motyw nieśmiertelności jako przekleństwa i duchowe konsekwencje ingerencji w naturalny porządek bardzo pasują do mistycznej warstwy Mooshu.",
    protagonist: "Sekiro",
    antagonist: "Genichiro Ashina",
    location: "Japonia (Ashina) w okresie Sengoku",
    description:
  ...
  "Dragon's Dogma: Dark Arisen": {
    world: "Avalon",
    why: "Avalon, bo to świat legend i bohaterów wpisanych w większy mit. Smok jako figura przeznaczenia, rycerskie wyprawy, klasyczne fantasy z nutą tragizmu – to wszystko brzmi jak ballada opowiadana przy ognisku w Avalonie. Do tego motyw cykliczności losu i iluzji bohaterstwa pasuje do arturiańskiej symboliki upadających królestw.",
  ...
  "Dragon's Dogma 2": {
    ...
    why: "Avalon – przez legendę o wybrańcu i rycersko-polityczny klimat konfliktów między królestwami. Krokotopia – bo pojawia się silniejszy motyw starożytnych pustynnych cywilizacji",
    protagonist: "Powstały",
    antagonist: "Smok",
    location: "Vermund, Battahl, Agamen",
    description:
  ...
  "Assassin's Creed": {
    ...
    why: "Avalon – przez rycerski klimat, krucjaty i konflikt ideologii osadzony w quasi-średniowiecznej strukturze władzy. Zafaria – bo to świat, który poza Afryką, inspiruje się również Bliskim Wschodem, na którym dzieje się akcja Assassin's Creed. Celestia – ze względu na warstwę Pierwszej Cywilizacji; starożytna, ukryta wiedza i artefakty pasują do motywu zatopionej, zapomnianej potęgi.",
    protagonist: "Altaïr Ibn-La'Ahad",
    antagonist: "Robert de Sablé",
    location: "Ziemia Święta końca XII wieku",
    description:
  ...
  "Assassin's Creed 2": {
    ...
    why: "Wysteria – renesansowa estetyka, artyzm, architektura i intelektualne odrodzenie idealnie współgrają z Florencją i Wenecją. Celestia – bo wątek Isu i starożytnych technologii zaczyna odgrywać większą rolę, a Celestia symbolizuje utracony, wysoko rozwinięty świat.",
    protagonist: "Ezio Auditore",
    antagonist: "Rodrigo Borgia",
    location: "XV-wieczne Włochy",
    description:
  ...
  "Assassin's Creed Brotherhood": {
    ...
    why: "Wysteria – centrum kultury i politycznej intrygi, gdzie sztuka i władza się przenikają, jak w renesansowym Rzymie. Dragonspyre – Dragonspyre to nie tylko chaos i zniszczenie. To również Rzym. Rzym, który odwiedzamy w tej części Assassin's Creed, a także motyw tyranii i miasta pod kontrolą despoty; upadek moralny władzy i brutalność Borgiów mają podobną energię co tyrania Malistaire'a. Celestia – dalsze odkrywanie sekretów starożytnej cywilizacji i technologii wykraczającej poza epokę.",
    protagonist: "Ezio Auditore",
    antagonist: "Cesare Borgia",
    location: "XVI-wieczny Rzym",
    description:
  ...
  "Assassin's Creed Revelations": {
    ...
    why: "Zafaria – Konstantynopol jako tygiel kultur, napięć i wpływów, głównie bliskowschodnich, podobnie jak Zafaria łączy różne siły w jednym, niestabilnym regionie. Celestia – refleksyjny ton gry i odkrywanie dawnych sekretów Altaïra współgrają z ideą zatopionej przeszłości i wiedzy ukrytej pod warstwą czasu.",
    protagonist: "Ezio Auditore",
    antagonist: "Ahmet",
    location: "XVI-wieczny Konstantynopol",
    description:
  ...
  "Assassin's Creed 4 Black Flag": {
    ...
    why: "Azteca – dzika natura, egzotyczne ruiny i atmosfera utraconych cywilizacji obecnych w tle pirackiej swobody. Celestia – motyw Pierwszej Cywilizacji i Obserwatorium jako technologii wykraczającej poza ludzkie rozumienie.",
    protagonist: "Edward Kenway",
    antagonist: "Laureano Torres",
    location: "XVIII-wieczne Karaiby",
    description:
  ...
  "Assassin's Creed Syndicate": {
    ...
    why: "Marleybone – industrialna, wiktoriańska estetyka, fabryki, dym i struktury klasowe idealnie oddają klimat Londynu epoki rewolucji przemysłowej. Celestia – wątek artefaktów i technologii kontrolującej ludzkość rezonuje z ideą zaawansowanej, dawnej cywilizacji.",
    protagonist: "Jacob Frye, Evie Frye",
    antagonist: "Crawford Starrick",
    location: "XIX-wieczna Anglia (Londyn)",
    description:
  ...
  "Assassin's Creed Origins": {
    ...
    why: "Krokotopia – oczywiste nawiązanie do starożytnego Egiptu, pustyń, piramid i konfliktu między tradycją a obcą dominacją. Celestia – narodziny Bractwa splatają się z ingerencją Pierwszej Cywilizacji; starożytna wiedza wpływa na przyszłość świata.",
    protagonist: "Bayek z Siwy",
    antagonist: "Flavius Metellus",
    location: "Starożytny Egipt i Zaświaty",
    description:
  ...
  "Assassin's Creed Odyssey": {
    ...
    why: "Aquila – grecka estetyka, mitologiczne bestie i heroiczna, niemal homerowa narracja pasują do świata inspirowanego klasyczną Helladą. Celestia – ogromna rola artefaktów Isu i motyw półboskiego dziedzictwa bohatera współgrają z ideą utraconej, potężnej cywilizacji.",
    protagonist: "Kassandra / Alexios",
    antagonist: "Deimos, Kult Kosmosa",
    location: "Starożytna Grecja i Zaświaty",
    description:
  ...
  "Assassin's Creed Valhalla": {
    world: "Grizzleheim, Celestia, Avalon",
    why: "Grizzleheim – nordycki klimat, surowa natura i mitologia wikingów to niemal bezpośrednie odbicie tego świata. Celestia – wątki Isu i boskich wizji Eivor łączą mit z technologią dawnej cywilizacji. Avalon – legenda arturiańska i motyw zderzenia nordyckiej brutalności z brytyjskim mitem rycerskim.",
    protagonist: "Eivor",
    antagonist: "Alfred Wielki, Zakon Starożytnych, Basim Ibn Ishaq",
    location:
      "Średniowieczna Anglia i Norwegia (a także 9 światów mitologii nordyckiej)",
    description:
  ...
  "Assassin's Creed Mirage": {
    world: "Zafaria, Celestia",
    why: "Zafaria – afrykański Bagdad jako centrum kultury, nauki i polityki przypomina świat pełen napięć i lokalnych frakcji, również afrykańskiej Zafarii. Celestia – wątek tożsamości Basima i powiązanie z pradawną cywilizacją silnie opiera się na idei ukrytej, starszej prawdy.",
    protagonist: "Basim Ibn Ishaq",
    antagonist: "Qabiha, Zakon Starożytnych",
    location: "IX-wieczny Bagdad",
    description:
  ...
  "Assassin's Creed Chronicles China": {
    world: "Mooshu",
    why: "Mooshu, ponieważ to świat inspirowany kulturą Chin i Azji Wschodniej, z naciskiem na duchowość, tradycję i estetykę przypominającą klasyczne malarstwo. Motyw odbudowy Bractwa w cieniu tyranii pasuje do narracji o honorze i przywracaniu równowagi w świecie Mooshu.",
    protagonist: "Shao Jun",
    antagonist: "Zhang Yong, Templariusze",
    location: "XVI-wieczne Chiny",
    description:
  ...
  "The Last of Us": {
    ...
    why: "Dragonspyre – świat po katastrofie, ruiny dawnej cywilizacji i poczucie, że to, co najgorsze, już się wydarzyło. Dragonspyre jest spalony przez pychę i wojnę — tak jak Ameryka po pandemii w TLOU. Darkmoor - Darkmoor to nie tylko gotyk, to także nieumarli, zombie, których w TLOU jest pełno",
    protagonist: "Joel, Ellie",
    antagonist: "Zarażeni, ludzie",
    location: "Postapokaliptyczne USA, 2033-2034 rok",
    description:
  ...
  "The Last of Us Part 2": {
    world: "Dragonspyre, Darkmoor",
    why: "Dragonspyre – motyw cyklu zniszczenia. Tam magia doprowadziła do samozagłady, tu nienawiść prowadzi do kolejnych tragedii. To świat, który już płonie — pytanie brzmi tylko, kto jeszcze w nim zostanie. Darkmoor – emocjonalny rozpad i obsesja. Part II to opowieść o zatruciu serca, a Darkmoor symbolizuje przestrzeń, gdzie ból i żal wypaczają rzeczywistość. Nie ma tu czystych bohaterów — tylko ofiary własnych wyborów.",
    protagonist: "Ellie, Abby",
    antagonist: "Abby, Ellie, zarażeni, ludzie",
    location: "Postapokaliptyczne USA, 2038-2039 rok",
    description:
  ...
  "Shadow of the Colossus": {
    world: "Azteca",
    why: "Azteca pasuje przez monumentalność ruin i obecność zapomnianej, pradawnej cywilizacji. Kolosy przypominają relikty świata, który już nie istnieje — tak jak w Aztece natura i ruiny dominują nad człowiekiem. Do tego motyw zakazanej mocy i ingerencji w naturalny porządek współgra z aurą dawnej, niebezpiecznej magii tego świata.",
    protagonist: "Wander",
    antagonist: "Dormin",
    location: "Zakazane Ziemie",
    description:
  ...
  "Red Dead Redemption 2": {
    ...
    why: "Zafaria – dzika natura, rozległe przestrzenie i konflikt między cywilizacją a pierwotnym światem. Marleybone – symbol modernizacji, prawa i porządku, które wypierają stary świat. Tak jak imperium Marleybone reprezentuje industrialny postęp, tak w RDR2 nadciąga epoka kolei, kapitalizmu i biurokracji. Azteca – przez motyw upadku dawnej potęgi i przemijania świata, który był „dziki i wolny”. Azteca to ruina cywilizacji; RDR2 to ruina mitu o wolnym Zachodzie. Również obecność Indian przypomina Aztecę, która jest inspirowana kulturą rdzennych ludów Ameryki",
    protagonist: "Arthur Morgan, John Marston",
    antagonist: "Micah Bell, Dutch van der Linde",
    location: "Dziki Zachód końca XVIII i początku XIX wieku",
    description:
  ...
  "Mafia Definitive Edition": {
    world: "Marleybone",
    why: "Marleybone, bo to świat industrialny, miejski i oparty na strukturach władzy. Gangsterskie rodziny działające w cieniu oficjalnego porządku przypominają polityczne intrygi i klasowy podział Marleybone. Estetyka noir, deszczowe ulice i architektura epoki pasują niemal idealnie.",
    protagonist: "Tommy Angelo",
    antagonist: "Don Morello, Don Salieri",
    location: "USA lat 1930-1938 (Lost Heaven)",
    description:
  ...
  "Serious Sam: The First Encounter": {
    world: "Krokotopia",
    why: "Krokotopia to oczywiste nawiązanie — starożytne egipskie ruiny, pustynne krajobrazy i monumentalne świątynie. W obu przypadkach mamy połączenie archeologicznej estetyki z czymś nadnaturalnym i kosmicznym. Różnica jest tonacyjna (Serious Sam jest absurdalny), ale sceneria pasuje w punkt.",
    protagonist: "Sam Stone",
    antagonist: "Mental",
    location: "Starożytny Egipt",
    description:
  ...
  "Serious Sam: The Second Encounter": {
    ...
    why: "Krokotopia – starożytne ruiny i pustynne klimaty. Azteca – dżungle i świątynie inspirowane prekolumbijską architekturą. Avalon – średniowieczne fortece i zamki, które pojawiają się w późniejszych etapach gry.",
    protagonist: "Sam Stone",
    antagonist:
      "Ameryka Południowa Majów, Starożytna Mezopotamia, Średniowieczna Polska",
    location: "",
    description:
  ...
  "DOOM 1 & 2": {
    ...
    why: "Dragonspyre – świat spalony przez własne ambicje i eksperymenty z potęgą przekraczającą granice. Lawowe krajobrazy i ruiny po katastrofie magicznej doskonale oddają piekielny klimat inwazji demonów. Celestia – motyw otwierania portali do innego wymiaru i ingerencji w siły większe niż człowiek. Eksperymenty UAC przypominają nieostrożne manipulowanie pradawną, kosmiczną energią.",
    protagonist: "Doomguy",
    antagonist: "Demony z Piekła",
    location: "Księżyce Marsa, Ziemia, Piekło, XXII wiek",
    description:
  ...
  "DOOM 64": {
    world: "Dragonspyre, Celestia",
    why: "Dragonspyre – cięższy, bardziej duszny klimat i poczucie, że wojna z Piekłem nigdy się nie kończy. Celestia – obecność Matki Demonów jako niemal kosmicznego bytu rezonuje z ideą wyższych, obcych sił wpływających na rzeczywistość.",
    protagonist: "Doomguy",
    antagonist: "Matka Demonów, Demony z Piekła",
    location: "Księżyce Marsa, Piekło, XXII wiek",
    description:
  ...
  "DOOM 3": {
    world: "Dragonspyre, Celestia",
    why: "Dragonspyre – katastrofa wywołana przez pychę i eksperymenty z mocą, która wymyka się spod kontroli. Celestia – portal jako naruszenie granicy między światami; ingerencja w sferę, której ludzkość nie rozumie. Tutaj Celestia podkreśla element „zakazanej wiedzy”, a nie epickiej mitologii.",
    protagonist: "DOOM Marine",
    antagonist: "Dr Malcolm Betruger, Demony z Piekła",
    location: "Mars, Piekło, 2145 rok",
    description:
  ...
  "DOOM 2016": {
    world: "Dragonspyre, Celestia",
    why: "Dragonspyre – bezpośrednie starcie z ogniem, piekłem i apokalipsą. Slayer to żywa broń w świecie, który już płonie. Celestia – Argent Energy i manipulacja energią o pozaziemskim pochodzeniu przywołują motyw czerpania mocy z sił spoza znanej rzeczywistości.",
    protagonist: "Doom Slayer",
    antagonist: "Olivia Pierce, Demony z Piekła",
    location: "Mars, Piekło, 2149 rok",
    description:
  ...
  "DOOM Eternal": {
    world: "Dragonspyre, Celestia",
    why: "Dragonspyre – totalna inwazja i krajobrazy zniszczenia przypominają świat po magicznej zagładzie. Celestia – konflikt z Maykr i kosmiczną hierarchią rozszerza serię do poziomu metafizycznego starcia między wyższymi bytami. To już nie tylko Piekło — to struktura wszechświata.",
    protagonist: "Doom Slayer",
    antagonist: "Khan Maykr, Ikona Grzechu, Władca Ciemności, Demony z Piekła",
    location: "Ziemia, Mars, Piekło, Argent D'Nur, Urdak, 2163 rok",
    description:
  ...
  "DOOM The Dark Ages": {
    world: "Dragonspyre, Celestia",
    why: "Dragonspyre – średniowieczne fortece w ogniu i brutalny, pierwotny charakter wojny z demonami idealnie pasują do ognistej estetyki tego świata. Celestia – geneza Slayera jako niemal mitycznej figury wpisuje się w narrację o istotach wybranych przez większe, kosmiczne siły.",
    protagonist: "Doom Slayer",
    antagonist: "Książę Ahzrak, Demony z Piekła",
    location: "Argent D'Nur, odległa przeszłość",
    description:
  ...
  "Ori and The Blind Forest": {
    world: "Khrysalis",
    why: "Khrysalis to świat przejścia między światłem a cieniem, życia i rozkładu. Podobnie jak Nibel, jest miejscem, gdzie natura została skażona, ale wciąż istnieje szansa na odrodzenie. Motyw równowagi i oczyszczania zepsutej energii pasuje do duchowej warstwy Khrysalis.",
    protagonist: "Ori",
    antagonist: "Kuro",
    location: "Las Nibel",
    description:
  ...
  "Ori and The Will of The Wisps": {
    world: "Khrysalis",
    why: "Khrysalis jeszcze mocniej rezonuje z drugą częścią — większy nacisk na przemijanie, akceptację straty i istnienie cienia jako nieodłącznej części świata. Shriek przypomina tragiczną istotę zrodzoną z odrzucenia i bólu, co idealnie wpisuje się w dualizm światła i mroku tego świata.",
    protagonist: "Ori",
    antagonist: "Shriek",
    location: "Kraina Niwen",
    description:
  ...
  "Heroes of Might and Magic 3": {
    world: "Avalon, Darkmoor, Dragonspyre, Zafaria, Azteca",
    why: "Avalon - średniowieczne królestwa i imperia. Darkmoor - armie nieumarłych. Dragonspyre - demony frakcji Inferno. Zafaria i Azteca - dzikie plemiona Twierdzy, Fortecy itp",
    protagonist:
      "Queen Catherine Ironfist, Lord Haart, Sir Christian, Gelu, Xeron, Dracon, Yog, Gem, Sandro, Crag Hack, Solmyr, Sir Mullich",
    antagonist:
      "Sandro, Mutare, Lord Haart, Xeron, Król Gryphonheart, Archibald Ironfist, Demons",
    location:
      "Kontynent Antagarich (Królestwo Erathii, Nighon, Eofol, Tatalia, Krewlod, AvLee)",
    description:
      "Klasyczna strategia turowa osadzona w świecie Enroth, w której gracze prowadzą bohaterów i armie fantastycznych stworzeń w walce o kontrolę nad królestwami Antagarichu. Kampanie opowiadają o wojnach między potęgami takimi jak Erathia, Nighon czy Eofol, a także o intrygach, zdradach i ambicjach bohaterów pokroju Sandro czy Mutare. Rozgrywka łączy zarządzanie miastami, eksplorację mapy i taktyczne bitwy, tworząc jedną z najbardziej kultowych strategii fantasy.",
  },

  "Might and Magic: Heroes 6": {
    world: "Avalon, Darkmoor, Mooshu, Dragonspyre, Zafaria, Azteca",
    why: "Avalon - średniowieczne królestwa i imperia. Darkmoor - armie nieumarłych i mrocznych elfów. Mooshu - orientalne świątynie Nag. Dragonspyre - Sheog i demony. Zafaria - Orkowie. Azteca - Orkowie.",
    protagonist:
      "Sławoj, Anton, Anatastazja, Kirył, Sandor, Irina, Crag Hack, Sandro, Raelag, Vein",
    antagonist: "Aniołowie, demony",
    location: "Ashan (Thallan, Sheog), 564 roku YSD (Year of the Sage Descent)",
    description:
      "Turn‑based RPG osadzone w uniwersum Might and Magic, w którym gracze kierują losami bohaterów takich jak Sławoj, Anton, Anatastazja czy Crag Hack. Każda postać posiada unikalne zdolności i możliwości rozwoju, a gracz buduje swoje armie, eksploruje różnorodne krainy i zdobywa potężne artefakty. Konflikty obejmują zarówno epickie starcia z demonami i aniołami, jak i strategiczne potyczki o kontrolę nad zamkami i zasobami. Gra łączy klasyczną taktykę, rozwój bohaterów i elementy narracyjne, tworząc świat, w którym każda decyzja może zmienić losy całego królestwa.",
  },

  "Warhammer 40k Dawn of War": {
    world: "Polaris, Zafaria, Azteca, Celestia, Dragonspyre, Darkmoor",
    why: "Polaris – zimny, militarny, bezosobowy charakter wojny totalnej. Polaris kojarzy się z konfliktem na wielką skalę, gdzie jednostka ma znaczenie tylko jako część armii. Zafaria – ciągła walka frakcji o dominację nad terytorium i wpływy pośród dzikiej natury. Azteca – brutalność, pierwotna siła i kultura wojny (Orkowie idealnie tu pasują). Ale również Dominium Tau, jako jaszczuroludzie przypominają azteckich dinozauroludzi Celestia – starożytne, kosmiczne technologie i pradawne moce (Eldarzy, Necroni, Warp jako wyższy wymiar). Dragonspyre – świat zniszczony przez niekontrolowaną potęgę; Chaos to dokładnie ta sama energia samozagłady. Darkmoor – nieumarli Necroni",
    protagonist: "Różne frakcje",
    antagonist: "Różne frakcje",
    location: "Tartarus, Lorn V, Kronus, Kaurava, 41 milenium",
    description:
  ...
  "Warhammer 40k Space Marine": {
    ...
    why: "Polaris – bezwzględna dyscyplina, wojskowy etos i chłodna lojalność wobec Imperium. Zafaria – konflikt o kontrolę nad światem-forge i strategiczne znaczenie planety. Orkowie są jak niezorganizowane plemiona Zafarii. Azteca – Orkowie również jako ucieleśnienie brutalnej, plemiennej siły. Dragonspyre – Chaos jako ogień herezji niszczący cywilizację od środka.",
    protagonist: "Kapitan Titus",
    antagonist: "Orkowie, Chaos",
    location: "Graia, 41 milenium",
    description:
  ...
  "Warhammer 40k Space Marine 2": {
    ...
    why: "Polaris – Imperium jako machina przetrwania w zimnym, obojętnym kosmosie. Khrysalis – Tyranidzi jako biologiczna, rojąca się siła natury, która pochłania wszystko jak pasożytniczy cień. Dragonspyre – Chaos wciąż reprezentuje niszczącą, demoniczną energię prowadzącą do upadku.",
    protagonist: "Kapitan Titus",
    antagonist: "Tyranidzi, Chaos",
    location: "Kadaku i Avarax, 42 milenium",
    description:
  ...
  "Warhammer 40k Boltgun": {
    ...
    why: "Polaris – czysta wojskowa ofensywa bez refleksji, tylko misja i eksterminacja. Dragonspyre – spalone twierdze, demoniczne siły i piekielna estetyka bitew z wyznawcami Chaosu.",
  ...
  "Starcraft 2": {
    ...
    why: "Polaris – kosmiczna wojna o przetrwanie i militarne struktury Terran. Khrysalis – Zerg jako biologiczny rój, który ewoluuje, asymiluje i pochłania — czysta energia życia wypaczonego w drapieżnictwo. Celestia – Protossi i Amon jako istoty o niemal boskim, pradawnym rodowodzie; konflikt o strukturę samego wszechświata.",
    protagonist: "Jim Raynor, Sarah Kerrigan, Hierarcha Artanis",
    antagonist: "Sarah Kerrigan, Amon, Arcturus Mengsk",
    location: "Sektor Koprulu, 2504-2508 rok",
    description:
  ...
  "Cyberpunk 2077": {
    world: "Celestia",
    why: "Celestia pasuje przez motyw zaawansowanej technologii przekraczającej ludzkie ograniczenia. To świat, w którym granica między człowiekiem a „wyższą formą” jest płynna. Biochip z osobowością Johnny’ego to niemal ingerencja obcej świadomości w strukturę jednostki — bardzo w duchu starożytnej, potężnej technologii Celestii.",
    protagonist: "V",
    antagonist: "Adam Smasher, korporacja Arasaka",
    location: "Futurystyczne USA (Night City), 2077 rok",
    description:
  ...
  "Detroit Become Human": {
    world: "Celestia",
    why: "Celestia, bo to świat pytań o stworzenie i przekroczenie własnych twórców. Androidy, które zyskują świadomość, przypominają motyw sztucznie powołanych istot osiągających autonomię. Celestia symbolizuje rozwiniętą cywilizację, która dotknęła granicy boskości — a Detroit bada dokładnie tę granicę w skali społecznej i moralnej.",
    protagonist: "Connor, Kara, Markus",
    antagonist: "Ludzkość",
    location: "Futurystyczne USA (Detroit), 2038 rok",
    description:
  ...
  "Mirror's Edge": {
    world: "Celestia, Polaris",
    why: "Futurystyczne miasto o nieskazitelnej budowie przypomina architekturę Celestii, natomiast reżim w nim panujący - Polaris",
    protagonist: "Faith Connors",
    antagonist: "Burfield (Ropeburn), Jacknife, burmistrz Callaghan",
    location: "Futurystyczne miasto",
    description:
      "Dynamiczna gra akcji z perspektywy pierwszej osoby skupiona na parkourze i płynnym poruszaniu się po dachach futurystycznego miasta. Faith Connors jest runnerką — kurierką przekazującą informacje poza kontrolowanym systemem komunikacji w państwie o silnym nadzorze. Historia koncentruje się na spisku politycznym i walce z autorytarnym systemem, a rozgrywka stawia na szybkość, refleks i kreatywne wykorzystywanie miejskiej przestrzeni.",
  },

  "Life is Strange": {
    world: "Wysteria",
    why: "Wysteria pasuje idealnie, bo to świat magii bardziej „kameralnej” i intelektualnej niż epickiej. Wysteria w Wizard101 jest magiczna, ale spokojna, szkolna, niemal akademicka — dokładnie jak Arcadia Bay. To historia o emocjach, relacjach i konsekwencjach wyborów, a nie o wielkiej wojnie. Subtelność, młodość i rozwój tożsamości są tu ważniejsze niż walka dobra ze złem.",
    protagonist: "Max Caulfield",
    antagonist: "Mark Jefferson",
    location: "USA (Arcadia Bay), 2013 rok",
    description:
  ...
  "Life is Strange Before The Storm": {
    world: "Wysteria",
    why: "Wysteria jeszcze mocniej — bo tu nie ma żadnych mocy cofania czasu, tylko emocjonalne starcie z rzeczywistością. Ten świat w Spiral ma aurę młodzieńczej rywalizacji, nauki i dojrzewania, co dobrze oddaje bunt, chaos i potrzebę bliskości Chloe. To bardziej dramat obyczajowy niż fantasy.",
    protagonist: "Chloe Price",
    antagonist: "Damon Merric",
    location: "USA (Arcadia Bay), 2010 rok",
    description:
  ...
  "Kangurek Kao": {
    ...
    why: "Zafaria – egzotyczna fauna, przygodowa energia i motyw dzikiej natury. Mooshu – duchowość, honor i podróż w celu przywrócenia równowagi. Khrysalis – wyraźny konflikt ze złowrogą, większą siłą i dojrzewanie bohatera do roli obrońcy świata.",
    protagonist: "Kao",
    antagonist: "Wieczny Wojownik",
    location:
      "Wyspa Hopalloo, Dojo Walta, Mroczny Las, Dolina Durianów, Jaskinie Lawy, Nora Terrora",
    description:
  ...
  "Sniper Elite 3": {
    world: "Zafaria",
    why: "Zafaria kojarzy się z otwartymi przestrzeniami, sawanną i surowym klimatem. Afryka Północna z gry ma podobne poczucie przestrzeni, piasku i słońca. Do tego wątek wojny i walki o kontrolę nad regionem wpisuje się w motyw konfliktów obecnych w tym świecie Spiral.",
    protagonist: "Karl Fairburne",
    antagonist: "Naziści",
    location: "Afryka Północna podczas II wojny światowej w 1942 roku",
    description:
  ...
  "Prince of Persia Warrior Within": {
    world: "Zafaria",
    why: "Zafaria przez motyw pradawnych ruin, piasku i surowej natury — ale też dlatego, że to świat, gdzie natura i pierwotne siły są potężne i nieokiełznane. Dahaka jako ucieleśnienie nieuchronności przypomina potężne byty pilnujące równowagi. Podróż przez czas i konsekwencje manipulacji nim mają też duchowy, niemal mitologiczny wydźwięk.",
    protagonist: "Książę Persji",
    antagonist: "Dahaka",
    location: "Wyspa Czasu",
    description:
  ...
  MediEvil: {
    world: "Darkmoor",
    why: "Darkmoor w Wizard101 to gotycki świat wampirów, ruin i przeklętych zamków. Atmosfera cmentarzy, nieumarłych i czarnej magii idealnie pokrywa się z groteskowym klimatem gry MediEvil. Jednocześnie Darkmoor, mimo mroku, ma w sobie nutę baśniowości — co świetnie pasuje do ironicznego bohaterstwa Sir Daniela.",
    protagonist: "Sir Daniel Fortesque",
    antagonist: "Zarok",
    location: "Gallowmere, 1386 rok",
    description:
  ...
  "Shadow of The Tomb Raider": {
    world: "Azteca",
    why: "Azteca to świat inspirowany kulturami prekolumbijskimi, dżunglą i motywami apokaliptycznych przepowiedni. W Wizard101 Azteca opiera się na wizji nadciągającej zagłady i upadku cywilizacji — dokładnie jak w historii Lary z Shadow of the Tomb Raider, gdzie pradawna przepowiednia i konsekwencje ingerencji bohaterki napędzają fabułę.",
    protagonist: "Lara Croft",
    antagonist: "Dr Pedro Dominguez (Amaru)",
    location: "Ameryka Łacińska (Meksyk, Peru), 2018 rok",
    description:
  ...
  "God of War": {
    world: "Aquila",
    why: "Aquila w Wizard101 jest bezpośrednio inspirowana mitologią grecką — mamy tam bogów, Herkulesa, gladiatorów i klasyczne, marmurowe ruiny. To świat heroizmu, ale też pychy i boskich manipulacji. Dokładnie tak jak w God of War, gdzie Kratos jest marionetką Aresa, a Olimpu bliżej do zepsutego dworu niż boskiego ideału.",
    protagonist: "Kratos",
    antagonist: "Ares",
    location: "Starożytna Grecja, Hades, Olimp",
    description:
  ...
  "God of War 2": {
    world: "Aquila",
    why: "Aquila idealnie oddaje motyw buntu przeciw boskiemu porządkowi. W tym świecie herosi rywalizują z bogami, a ambicja często prowadzi do upadku. Konflikt Kratosa z Zeusem to czysta tragedia w stylu antycznej dramy — dokładnie w duchu aren i mitologicznych prób Aquili.",
    protagonist: "Kratos",
    antagonist: "Zeus",
    location: "Starożytna Grecja, Hades, Olimp",
    description:
  ...
  "God of War Ghost of Sparta": {
    world: "Aquila",
    why: "Aquila pasuje przez silny motyw tragedii rodzinnej i fatum. Ten świat w Spiral opiera się na klasycznej strukturze greckiego dramatu: grzech, kara, nieuchronność losu. Walka z Thanatosem to niemal dosłowna konfrontacja z personifikacją przeznaczenia — coś bardzo „aquilańskiego”.",
    protagonist: "Kratos",
    antagonist: "Thanatos",
    location: "Starożytna Grecja, Hades",
    description:
  ...
  "God of War Chains of Olympus": {
    world: "Aquila",
    why: "Aquila jako świat młodych herosów w służbie bogów. W grze Kratos jeszcze wykonuje rozkazy Olimpu, a Aquila w Wizard101 też pokazuje relację zależności między herosem a boską wolą. Morfeusz i Persefona wpisują się w klasyczny, mitologiczny repertuar tego świata.",
    protagonist: "Kratos",
    antagonist: "Morfeusz, Persefona",
    location: "Starożytna Grecja, Hades, Pola Elizejskie, Olimp",
    description:
  ...
  "God of War Wstąpienie": {
    world: "Aquila",
    why: "Furie jako strażniczki przysięgi i kary za zdradę idealnie współgrają z duchem Aquili — świata opartego na honorze, przysięgach i ich łamaniu. To niemal podręcznikowy przykład mitologicznej odpłaty, jaka w tym świecie jest czymś naturalnym.",
    protagonist: "Kratos",
    antagonist: "Furie (Alekta, Megaera, Tyzyfone)",
    location: "Starożytna Grecja",
    description:
  ...
  "God of War 3": {
    world: "Aquila",
    why: "Aquila to arena wielkich, przesadzonych pojedynków i upadku bogów. W God of War III mamy dosłowną destrukcję Olimpu — czyli kulminację tego, co Aquila symbolizuje: boską pychę i jej katastrofalne konsekwencje. To mit o zniszczeniu porządku świata przez jednego człowieka.",
    protagonist: "Kratos",
    antagonist: "Zeus",
    location: "Starożytna Grecja, Hades, Olimp",
    description:
  ...
  "God of War 2018": {
    world: "Grizzleheim",
    why: "Grizzleheim w Wizard101 jest światem inspirowanym nordycką mitologią: mroźne krajobrazy, pradawne drzewa, runy, duchy wojowników. Klimat surowej natury i legend idealnie pokrywa się z God of War. Co więcej, Grizzleheim kładzie nacisk na honor, przeznaczenie i dawne proroctwa — czyli dokładnie to, co napędza relację Kratosa i Atreusa.",
    protagonist: "Kratos i Atreus",
    antagonist: "Baldur",
    location:
      "9 światów mitologii nordyckiej (Midgard, Alfheim, Jötunheim, Helheim, Muspelheim, Niflheim)",
    description:
  ...
  "God of War Ragnarok": {
    world: "Grizzleheim",
    why: "Grizzleheim to świat nadciągającej zagłady i cyklicznego losu. Motyw końca ery i zmiany porządku świata jest tam bardzo silny. W God of War Ragnarök mamy apokaliptyczny konflikt bogów, który przypomina legendy opowiadane przy ognisku w nordyckiej krainie Spiral. To nie tylko wojna — to koniec starego świata i narodziny nowego, co idealnie pasuje do symboliki Grizzleheim.",
    protagonist: "Kratos i Atreus",
    antagonist: "Odyn, Thor",
    location:
      "9 światów mitologii nordyckiej (Midgard, Asgard, Vanaheim, Alfheim, Jötunheim, Svartalfheim, Helheim, Muspelheim, Niflheim)",
    description:
  ...
  "Ghost of Tsushima": {
    world: "Mooshu",
    why: "Mooshu w Wizard101 jest wyraźnie inspirowane feudalną Japonią — pagody, duchy przodków, samurajski etos, estetyka sakury i honoru. To dokładnie ten sam duch, który napędza Ghost of Tsushima. Motyw konfliktu między tradycyjnym kodeksem a koniecznością złamania zasad idealnie pasuje do Mooshu, gdzie równowaga i honor są fundamentem świata.",
    protagonist: "Jin Sakai",
    antagonist: "Khotun Chan, Mongołowie",
    location: "XIII-wieczna Japonia (Cuszima)",
    description:
  ...
  "Ghost of Yotei": {
    world: "Mooshu",
    why: "Choć to późniejszy okres historyczny, klimat nadal pozostaje mocno osadzony w japońskiej estetyce — a Mooshu jest spiralowym odpowiednikiem tej kultury. Zemsta, renegaccy samuraje, powrót do rodzinnych stron i duch przeszłości unoszący się nad krajobrazem — to bardzo „mooshuowe”. Motyw osobistej vendetty w świecie pełnym tradycji i duchowości pasuje tu jak rękawica.",
    protagonist: "Atsu",
    antagonist: "Lord Nariaki Saito i Yōtei Six",
    location: "XVII-wieczna Japonia (Ezo, dzisiejsze Hokkaido)",
    description:
  ...
  Undertale: {
    world: "Wizard City",
    why: "Wizard City to miejsce, gdzie młody adept magii uczy się, kim chce być. Undertale opiera się dokładnie na tym samym fundamencie: wybór drogi definiuje twoją tożsamość. Podziemie pełne potworów, które okazują się bardziej „ludzkie” niż ludzie, pasuje do bajkowej, ale moralnie niejednoznacznej atmosfery Wizard City. To świat nauki, dorastania i pierwszych wielkich decyzji.",
    protagonist: "Frisk",
    antagonist: "Flowey",
    location: "Podziemia, XXII wiek",
    description:
  ...
  Portal: {
    world: "Celestia",
    why: "Celestia w Wizard101 to świat czystej energii, gwiazd, abstrakcji i niemal laboratoryjnej estetyki kosmosu. Portal idealnie wpasowuje się w tę chłodną, sterylną, intelektualną przestrzeń. Testy, manipulacja rzeczywistością, eksperymenty naukowe — to klimat bardziej kosmiczny i konceptualny niż ziemski.",
    protagonist: "Chell",
    antagonist: "GLaDOS",
    location: "Aperture Science Enrichment Center, 2010 rok",
    description:
  ...
  "Portal 2": {
    world: "Celestia",
    why: "Rozwinięcie motywu sztucznej inteligencji i upadłego laboratorium jeszcze mocniej pasuje do Celestii jako miejsca wiedzy, która wymyka się spod kontroli. Humor GLaDOS i absurd Wheatleya kontrastują z chłodnym, niemal transcendentalnym klimatem kosmicznego świata — co tworzy ciekawą dychotomię.",
    protagonist: "Chell",
    antagonist: "GLaDOS, Wheatley",
    location: "Aperture Science Enrichment Center, między 2060, a 50210 rokiem",
    description:
  ...
  Valheim: {
    world: "Grizzleheim",
    why: "Grizzleheim w Wizard101 to nordycki świat wikingów, run, pradawnych duchów i mroźnych lasów. Valheim jest praktycznie survivalową wersją tej samej mitologii. Surowa natura, próby bogów i walka o przetrwanie — klimat niemal identyczny.",
    protagonist: "Wiking",
    antagonist: "Potwory, boskie próby",
    location: "10-ty świat mitologii nordyckiej (Valheim)",
    description:
  ...
  "A Way Out": {
    world: "Marleybone",
    why: "Marleybone to świat inspirowany industrialną Anglią, z silnym motywem prawa, porządku i przestępczości w cieniu cywilizacji. A Way Out z jego więzienną ucieczką, dramatem relacji i brudnym realizmem świetnie wpisuje się w klimat świata, gdzie system i struktura społeczna mają ogromne znaczenie.",
    protagonist: "Leo i Vincent",
    antagonist: "Okoliczności i wrogowie więzienni",
    location: "USA (Five Lakes) w latach 70. XX wieku",
    description:
  ...
  Creaks: {
    world: "Darkmoor",
    why: "Darkmoor w Wizard101 to świat gotycki, pełen mroku, tajemniczych budowli i dziwnych stworzeń. Creaks ze swoim surrealistycznym budynkiem, ożywającymi meblami i niepokojącą estetyką idealnie oddaje ten klimat. To nie horror wprost — raczej melancholijna baśń w cieniu.",
    protagonist: "Bohater",
    antagonist: "Wielki Kot",
    location: "Podziemny Labirynt",
    description:
  ...
  Superhot: {
    world: "Celestia",
    why: "Celestia to świat wiedzy, czasu i kosmicznych praw rządzących rzeczywistością. Mechanika SUPERHOT, w której czas porusza się tylko wraz z ruchem gracza, idealnie pasuje do celestiańskiej obsesji na punkcie kontroli czasu i zrozumienia fundamentalnych zasad istnienia. Minimalistyczna forma gry i jej abstrakcyjny charakter przypominają eksperymenty Celestian z rzeczywistością, gdzie gracz – podobnie jak uczeń magii – musi zrozumieć reguły świata, aby przetrwać.",
    protagonist: "Gracz",
    antagonist: "SUPERHOT.exe",
    location: "Wirtualna rzeczywistość, przyszłość",
    description:
  ...
  "Superhot Mind Control Delete": {
    world: "Celestia",
    why: "Rozwinięcie filozoficznych wątków kontroli, iluzji wolnej woli i manipulacji systemem silnie koresponduje z upadkiem Celestii i konsekwencjami ingerowania w prawa kosmosu. „System” jako antagonista odzwierciedla ideę wiedzy, która wymknęła się spod kontroli – dokładnie tak, jak celestiańska technologia i magia czasu. Gra pasuje do Celestii jako opowieść o cenie absolutnego poznania.",
    protagonist: "Gracz",
    antagonist: "System",
    location: "Wirtualna rzeczywistość, przyszłość",
    description:
  ...
  Returnal: {
    world: "Khrysalis",
    why: "Khrysalis to świat cykli, cierpienia i niekończącej się walki z przeznaczeniem. Pętla śmierci i odrodzenia Selene idealnie wpisuje się w motyw stagnacji i uwięzienia, który dominuje w Khrysalis. Obca, wroga planeta z tajemniczą historią przypomina krainę zniszczoną przez długotrwały konflikt, a psychologiczny ciężar gry pasuje do mrocznego, przytłaczającego klimatu tego świata.",
    protagonist: "Selene",
    antagonist: "Cykl czasowy, obcy",
    location: "Planeta Atropos w przyszłości, Ziemia w teraźniejszości",
    description:
  ...
  "Ultimate Spiderman": {
    ...
    why: "Wizard City odzwierciedla etap nauki i dorastania – dokładnie tak jak młody Peter Parker uczący się bycia bohaterem. Marleybone natomiast, ze swoją industrialną atmosferą i moralnymi szarościami, pasuje do konfliktu z Venomem – istotą będącą mrocznym odbiciem protagonisty. Gra łączy niewinność początków z pierwszym prawdziwym zetknięciem się z konsekwencjami własnych wyborów.",
  ...
  "Marvel Spiderman": {
    world: "Wizard City, Marleybone",
    why: "Doświadczony Peter Parker funkcjonuje na granicy ideałów i brutalnej rzeczywistości – podobnie jak czarodziej opuszczający bezpieczne Wizard City i mierzący się z problemami Marleybone. Motyw odpowiedzialności, poświęcenia i konfliktu między nauką a etyką (Doktor Octopus) silnie rezonuje z tematami świata, w którym technologia i ambicja zaczynają dominować nad moralnością.",
    protagonist: "Peter Parker",
    antagonist: "Doktor Octopus",
    location: "Nowy Jork (Manhattan), 2018 rok",
    description:
  ...
  "Marvel Spiderman: Miles Morales": {
    world: "Wizard City, Marleybone",
    why: "Miles Morales to bohater na początku swojej drogi, uczący się, kim chce być i jakie wartości wyznawać. Wizard City symbolizuje fundamenty – naukę i wsparcie mentorów – a Marleybone reprezentuje świat realnych konfliktów społecznych, politycznych i technologicznych. Historia Milesa idealnie wpisuje się w przejście od teorii do praktyki i w poszukiwanie własnej tożsamości w skomplikowanym świecie.",
    protagonist: "Miles Morales",
    antagonist: "Simon Krieger",
    location: "Nowy Jork (Manhattan), 2019 rok",
    description:
  ...
  "Marvel Spiderman 2": {
    world: "Wizard City, Marleybone",
    why: "Podwójna perspektywa Petera i Milesa odzwierciedla konflikt pomiędzy tradycją a nowym podejściem do bohaterstwa. Venom jako siła chaosu i emocjonalnego rozkładu pasuje do napięć Marleybone, gdzie granice moralności są stale testowane. Jednocześnie Wizard City przypomina o pierwotnych ideałach, które bohaterowie muszą chronić, nawet gdy świat staje się coraz bardziej niejednoznaczny.",
    protagonist: "Peter Parker, Miles Morales",
    antagonist: "Venom",
    location: "Nowy Jork (Manhattan), 2020 rok",
    description:
  ...
  "LEGO Ninjago Film Gra": {
    world: "Mooshu",
    why: "Mooshu to świat honoru, mistrzów i uczniów, w którym tradycja i duchowa równowaga są kluczowe. Ninja z LEGO Ninjago przechodzą podobną drogę – szkolą się, popełniają błędy i uczą się współpracy. Motywy wschodnich sztuk walki, dyscypliny oraz walki z wewnętrznymi słabościami doskonale pasują do estetyki i filozofii Mooshu.",
    protagonist: "Ninja",
  ...
  "LEGO Marvel Super Heroes": {
    world: "Wizard City, Marleybone, Grizzleheim",
    why: "Wizard City reprezentuje różnorodność bohaterów i naukę kontrolowania unikalnych zdolności, co idealnie pasuje do ogromnej galerii postaci Marvela. Marleybone natomiast odpowiada miejskiej scenerii, zagrożeniom na dużą skalę i konfliktom wynikającym z ambicji złoczyńców takich jak Loki czy Doctor Doom. Grizzleheim z kolei pasuje do wątków z mitologii nordyckiej obecnych w grze. Humor LEGO łagodzi powagę tematów, podobnie jak lekki ton Wizard101 równoważy epickie zagrożenia.",
    protagonist: "Bohaterowie Marvela",
    antagonist: "Loki, Doctor Doom i inni złoczyńcy",
    location:
      "Nowy Jork (Manhattan), Asgard, Jotunheim i różne miejsca na Ziemi",
    description:
  ...
  "LEGO Harry Potter Lata 1–4": {
    world: "Wizard City",
    why: "Wizard City symbolizuje początek drogi magicznej – naukę zaklęć, pierwszych mentorów i odkrywanie własnego potencjału. Lata 1–4 Harry’ego Pottera idealnie wpisują się w ten etap: bohaterowie uczą się podstaw magii, eksplorują szkołę i stopniowo odkrywają, że świat czarów kryje także realne zagrożenia. Lekki ton LEGO odpowiada bezpiecznej, edukacyjnej atmosferze Wizard City.",
    protagonist: "Harry Potter, Ron Weasley, Hermiona Granger",
    antagonist: "Lord Voldemort",
    location: "Hogwart 1991-1995 rok",
    description:
  ...
  "LEGO Harry Potter Lata 5–7": {
    world: "Wizard City",
    why: "Choć historia staje się mroczniejsza, jej rdzeń nadal tkwi w rozwoju młodego czarodzieja, który przeszedł już podstawowe szkolenie. Wizard City w tym ujęciu reprezentuje wspomnienie fundamentów – wartości, przyjaźni i nauk wyniesionych z początków edukacji magicznej, które są kluczowe w ostatecznej walce ze złem. To moment, gdy uczeń staje się pełnoprawnym czarodziejem.",
    protagonist: "Harry Potter, Ron Weasley, Hermiona Granger",
    antagonist: "Lord Voldemort",
    location: "Hogwart 1996-1998 rok",
    description:
  ...
  "Harry Potter i Kamień Filozoficzny": {
    world: "Wizard City",
    why: "Pierwsze zetknięcie Harry’ego z magią to idealny odpowiednik przybycia gracza do Wizard City. Nauka zaklęć, eksploracja szkoły, zagadki i poczucie zachwytu nad nowym światem doskonale oddają rolę Wizard City jako bramy do magicznego uniwersum. To opowieść o odkrywaniu własnej tożsamości jako czarodzieja.",
    protagonist: "Harry Potter",
    antagonist: "Lord Voldemort",
    location: "Hogwart 1991 rok",
    description:
  ...
  "Hogwart's Legacy": {
    world: "Wizard City",
    why: "Wizard City to miejsce, gdzie gracz kształtuje własną ścieżkę magiczną – dokładnie tak jak w Hogwart’s Legacy. Tworzenie własnego ucznia, rozwijanie stylu magii i eksploracja świata czarodziejów idealnie oddają ideę Wizard City jako centrum nauki, eksperymentowania i odkrywania sekretów magii, zanim przyjdzie zmierzyć się z większymi zagrożeniami Spiral.",
    protagonist: "Nowy uczeń Hogwartu",
    antagonist: "Ranrok",
    location: "Hogwart, lata 90. XIX wieku",
    description:
  ...
  "School of Dragons": {
    world: "Grizzleheim",
    why: "Grizzleheim to świat wojowników, klanów i surowej natury, gdzie siła, lojalność i więź z bestiami odgrywają kluczową rolę. Relacja trenera ze smokiem w School of Dragons idealnie pasuje do nordyckiego ducha Grizzleheim – zamiast czystej magii liczy się współpraca, zaufanie i hart ducha w obliczu niebezpieczeństw.",
    protagonist: "Trener smoków",
    antagonist: "Nikora Stormheart",
    location:
      "Skandynawia (Berk, Koniec Świata, Smocza Akademia) za czasów wikingów",
    description:
  ...
  "Rise of Berk": {
    world: "Grizzleheim",
    why: "Budowanie i obrona Berk odzwierciedlają życie w świecie ciągłych konfliktów, charakterystycznym dla Grizzleheim. Zarządzanie zasobami, przygotowanie na ataki i wzmacnianie społeczności pasują do świata, w którym przetrwanie zależy od siły wspólnoty i gotowości do walki.",
    protagonist: "Trener smoków",
    antagonist: "Wrogowie Berk",
    location: "Skandynawia (Berk) za czasów wikingów",
    description:
  ...
  "Titan Uprising": {
    world: "Grizzleheim",
    why: "Tytani i potężne smoki przywodzą na myśl legendarne bestie północnych mitów. Grizzleheim jako świat sag i heroicznych opowieści idealnie pasuje do historii o rosnącym zagrożeniu i bohaterach, którzy muszą stanąć do walki, by chronić swój lud.",
    protagonist: "Trener smoków",
    antagonist: "Maeve",
    location: "Skandynawia (Berk) za czasów wikingów",
    description:
  ...
  "How To Train Your Dragon": {
    world: "Grizzleheim",
    why: "Gra skupia się na bezpośrednim sterowaniu postacią, walce oraz zadaniach zręcznościowych osadzonych w surowym, nordyckim świecie pełnym niebezpieczeństw. Grizzleheim pasuje do niej jako kraina, w której liczy się sprawność fizyczna, odwaga i praktyczne umiejętności, a nie klasyczna nauka magii. Mechanika gry – pojedynki, eksploracja i wyzwania terenowe – odzwierciedla brutalniejszy, bardziej pierwotny charakter tego świata.",
  ...
  "How To Train Your Dragon 2": {
    world: "Grizzleheim",
    why: "Druga gra rozwija elementy akcji i eksploracji, kładąc większy nacisk na współpracę z innymi jeźdźcami smoków oraz wykonywanie misji w niebezpiecznych regionach. Grizzleheim jako świat konfliktów i heroicznych prób doskonale pasuje do rozgrywki opartej na walce, rywalizacji i testowaniu umiejętności gracza. Gra podkreśla konieczność adaptacji do coraz trudniejszych wyzwań – kluczowy motyw tego świata.",
  ...
  "Dawn Of New Riders": {
    world: "Grizzleheim",
    why: "Nowi bohaterowie i zapomniane krainy doskonale wpisują się w mitologiczną naturę Grizzleheim, gdzie każda legenda może kryć prawdę. Motyw odkrywania pradawnych mocy i budowania więzi ze smokiem odpowiada duchowi nordyckiej przygody.",
    protagonist: "Scribbler",
    antagonist: "Eir Stormheart",
    location:
      "Skandynawia (Havenholme, Góra Valki, Blood Briar) za czasów wikingów",
    description:
  ...
  "Dragons Nine Realms": {
    world: "Khrysalis",
    why: "Dziewięć krain smoków i świat naznaczony upadkiem dawnej cywilizacji doskonale pasują do Khrysalis – świata zrujnowanego, pełnego tajemnic i pozostałości po wielkiej katastrofie. Motyw odbudowy, przetrwania i współistnienia z niebezpiecznymi istotami odzwierciedla walkę o przyszłość w cieniu przeszłych błędów.",
    protagonist: "Thunder",
    antagonist: "Smoki",
    location: "Ukryty Świat, współcześnie",
    description:
  ...
  "Dragons Wild Skies": {
    world: "Grizzleheim",
    why: "Swoboda lotu, eksploracja dzikich terenów i ciągła obecność natury podkreślają surowość i majestat Grizzleheim. To świat, w którym niebo, ziemia i bestie są równie niebezpieczne, co piękne, a wolność zawsze wiąże się z ryzykiem.",
    protagonist: "Trener smoków",
    antagonist: "-",
    location: "Skandynawia (Berk) za czasów wikingów",
    description:
  ...
  "Reksio i Skarb Piratów": {
    world: "Zafaria",
    why: "Zafaria to świat dzikiej natury, zapomnianych ruin i przygodowej eksploracji, gdzie bohater trafia na nieznane terytoria rządzące się własnymi prawami. Tropikalna wyspa, piraci, jaskinie i wulkany z gry doskonale pasują do klimatu Zafarii jako miejsca pełnego niebezpieczeństw, ale też odkryć. Motyw wyprawy w nieznane i konfrontacji z „obcą” kulturą jest wspólny dla obu światów.",
    protagonist: "Reksio",
    antagonist: "Piraci",
    location: "Wyspa Skarbów",
    description:
  ...
  "Reksio i UFO": {
    ...
    why: "Celestia odpowiada za wątek kosmiczny, obce planety i ingerencję istot wyższych w losy świata – dokładnie tak jak Kurator i cywilizacja UFO. Khrysalis natomiast pasuje do motywu zniewolenia i manipulacji życiem (porywanie kur, eksperymenty, kontrola). Gra balansuje między absurdem a poważniejszym pytaniem o ingerencję w naturalny porządek, co dobrze łączy oba światy.",
  ...
  "Reksio i Czarodzieje": {
    world: "Wizard City",
    why: "Wizard City jest centrum magii, nauki i chaotycznych eksperymentów czarodziejów. Historia o „tym, który tak potwornie mąci” idealnie wpisuje się w motyw magii wymykającej się spod kontroli. Reksio i Kretes funkcjonują tu jak nietypowi adepci – rozwiązują magiczne problemy nie siłą, lecz sprytem i logiką, co doskonale pasuje do ducha Wizard City.",
    protagonist: "Reksio, Kretes",
    antagonist: "Ten, który tak potwornie mąci",
    location: "Kraina Czarów",
    description:
  ...
  "Reksio i Wehikuł Czasu": {
    ...
    why: "Gra jest podróżą przez epoki i cywilizacje, a każdy z wymienionych światów reprezentuje inny aspekt czasu i historii: Azteca – pierwotność, zagłada i walka z losem, Celestia – manipulacja czasem, przyszłość i wiedzą, Krokotopia – starożytne ruiny i zapomniane sekrety, Avalon – legendy, rycerstwo i mit. Wehikuł czasu spina te motywy w jedną przygodową całość.",
    protagonist: "Reksio, Kretes",
    antagonist: "Zakon Ryżokitowców",
    location: "Przeszłość, teraźniejszość, przyszłość",
    description:
  ...
  "Reksio i Kapitan Nemo": {
    ...
    why: "Marleybone odpowiada za industrialny, steampunkowy klimat technologii i maszyn (Nautilus, podróże, inżynieria), natomiast Krokotopia za motyw starożytnych tajemnic i zagubionych cywilizacji. Połączenie nauki, podróży i eksploracji nieznanych miejsc dobrze oddaje charakter obu światów.",
    protagonist: "Reksio, Kretes",
    antagonist: "Kapitan Nemo (i niespodziewane przeciwności)",
    location: "Paryż, Konstantynopol, Egipt, przełom XIX i XX wieku",
    description:
  ...
  "Reksio i Kretes w Akcji": {
    ...
    why: "Gra jest przekrojowym „zbiorem wspomnień” z całej serii, podobnie jak Spiral w Wizard101 łączy wiele światów w jedną całość. Brak jednej fabuły, różnorodność stylów rozgrywki i szybkie zmiany scenerii sprawiają, że tytuł naturalnie pasuje do koncepcji podróży między światami.",
    protagonist: "Reksio i Kretes",
    antagonist: "Różni",
    location: "Podwórko Reksia",
    description:
  ...
  "Reksio i Kretes: Tajemnica Trzeciego Wymiaru": {
    world: "Wysteria",
    why: "Wysteria to świat eksperymentów, alternatywnych podejść i „innego spojrzenia” na magię. Przejście serii Reksio w pełne 3D i zabawa koncepcją trzeciego wymiaru doskonale pasują do Wysterii jako miejsca łamiącego schematy i klasyczne reguły rzeczywistości.",
    protagonist: "Reksio i Kretes",
    antagonist: "Trzeci wymiar",
    location: "Mroczna Wieża",
    description:
  ...
  "Star Wars Battlefront 2": {
    world: "Celestia, Khrysalis",
    why: "Celestia reprezentuje konflikt na skalę kosmiczną, zaawansowaną technologię i walkę o kontrolę nad wiedzą oraz przestrzenią. Khrysalis natomiast pasuje do wątku upadku Imperium, wojny totalnej i moralnej pustki po zniszczeniu starego porządku. Kampania Iden Versio idealnie wpisuje się w motyw świata, który musi zdecydować, co zbudować po katastrofie.",
    protagonist: "Iden Versio, różne frakcje",
    antagonist: "Różne frakcje",
    location: "Odległa Galaktyka, 5 ABY",
    description:
  ...
  "GTA 5 Online": {
    ...
    why: "Marleybone odpowiada za wielkie miasto, przestępczość, industrialny chaos i walkę o wpływy, natomiast Wizard City symbolizuje „plac zabaw” – miejsce, gdzie gracze uczą się systemów, mechanik i tworzą własne historie. GTA Online to sandbox społeczny, w którym kreatywność graczy jest ważniejsza niż narzucona fabuła.",
    protagonist: "Gracz",
    antagonist: "-",
  ...
  "Ark Survival Evolved": {
    world: "Azteca",
    why: "Azteca to świat pierwotny, brutalny i rządzony przez naturę oraz dinozaury. ARK idealnie oddaje ten klimat: przetrwanie, walka z bestiami, brak technologicznego komfortu i ciągłe zagrożenie zagładą. Motyw ujarzmiania pradawnych stworzeń i życia w cieniu większych sił jest wspólny dla obu światów.",
    protagonist: "Ocalały",
    antagonist: "Dinozaury, środowisko",
    location: "Wyspa w Kosmosie, przyszłość",
    description:
  ...
  "Don't Starve": {
    ...
    why: "Zafaria odpowiada za pierwotną walkę o przetrwanie w dzikim, nieprzyjaznym środowisku, gdzie natura jest równie groźna jak potwory. Darkmoor natomiast idealnie pasuje do gotyckiego tonu gry: szaleństwa, cieni, manipulacji Maxwell’a i świata istniejącego „po drugiej stronie”. Połączenie obu światów oddaje balans Don’t Starve między surową naturą a psychologicznym horrorem.",
    protagonist: "Wilson, inni ocalali",
    antagonist: "Maxwell",
    location: "The Constant, lata 1910-1921",
    description:
  ...
  "Don't Starve Together": {
    world: "Zafaria, Darkmoor",
    why: "Kooperacja w obliczu nieustannego zagrożenia podkreśla plemienny aspekt Zafarii – przetrwanie dzięki współpracy. Jednocześnie obecność Charlie i samej Ciemności wpisuje się w Darkmoor jako świat, gdzie mrok jest aktywną, świadomą siłą. Gra pokazuje, że nawet razem gracze nie są bezpieczni przed szaleństwem i koszmarem.",
    protagonist: "Wilson, inni ocalali",
  ...
  Phasmophobia: {
    world: "Darkmoor",
    why: "Darkmoor to esencja nawiedzonych miejsc, duchów i klątw. Phasmophobia idealnie oddaje ten klimat: opuszczone lokacje, niewidzialne zagrożenie i ciągłe poczucie, że gracz jest intruzem w świecie zmarłych. Brak klasycznej walki wzmacnia bezsilność, tak charakterystyczną dla Darkmoor.",
    protagonist: "Zespół łowców duchów",
    antagonist: "Duchy",
    location: "Czasy współczesne",
    description:
  ...
  "Among Us": {
    world: "Celestia",
    why: "Celestia to świat zaawansowanej wiedzy, technologii i kosmicznej izolacji. Among Us przenosi te motywy na poziom społeczny: zamknięta przestrzeń, ukryty sabotażysta i konieczność logicznego myślenia. Impostor działa jak błąd w systemie – dokładnie tak, jak problemy, które doprowadziły Celestię do upadku.",
    protagonist: "Załoga statku",
    antagonist: "Impostor",
    location: "Stacja kosmiczna, przyszłość",
    description:
  ...
  "Diablo Immortal": {
    world: "Dragonspyre",
    why: "Dragonspyre to świat spustoszony przez niekończącą się wojnę i obsesję na punkcie potęgi. Diablo Immortal idealnie wpisuje się w ten motyw: ciągła walka z demonami, ruiny dawnych cywilizacji i bohaterowie żyjący tylko po to, by walczyć. Skarn jako Herold Grozy pasuje do dragonspyrowskiej wizji świata, który sam sprowadził na siebie zagładę.",
    protagonist: "Łowca demonów",
    antagonist: "Skarn, Herold Grozy",
    location: "Sanktuarium, 1270 AK (Anno Kalandra)",
    description:
  ...
  "Martha is Dead": {
    world: "Wysteria",
    why: "Wysteria to świat złudzeń, alternatywnych narracji i podważania rzeczywistości. Martha is Dead balansuje dokładnie na tej granicy: między prawdą a projekcją umysłu, historią a traumą. Gra pokazuje, jak rzeczywistość może się rozpadać pod wpływem psychicznego bólu – kluczowy motyw Wysterii.",
    protagonist: "Giulia",
    antagonist: "Irene, Biała Dama, trauma",
    location: "Włochy (Toskania) podczas II wojny światowej, 1944 rok",
    description:
  ...
  "Sherlock Holmes Chapter One": {
    world: "Wysteria, Marleybone",
    why: "Marleybone reprezentuje racjonalizm, miasto, śledztwa i logikę – fundament detektywistycznej rozgrywki. Wysteria natomiast pasuje do śródziemnomorskiego klimatu, a także wątku wewnętrznych złudzeń Sherlocka, jego dialogów z własnym umysłem i niepewności co do prawdy. Gra stoi dokładnie na granicy faktu i interpretacji.",
    protagonist: "Młody Sherlock Holmes",
    antagonist: "Doktor Otto Richter",
    location: "Śródziemnomorska wyspa Cordona, 1880 rok",
    description:
  ...
  "Sherlock Holmes The Awakened": {
    world: "Darkmoor, Marleybone",
    why: "Marleybone daje ramy klasycznego śledztwa w wiktoriańskim Londynie, natomiast Darkmoor przejmuje kontrolę, gdy historia skręca w kosmiczny horror. Kulty, starożytne artefakty i utrata stabilności psychicznej idealnie pasują do Darkmoor jako świata zakazanej wiedzy i obłędu.",
    protagonist: "Sherlock Holmes, John Watson",
    antagonist: "Lord Rochester, kultyści Cthulhu",
    location:
      "Anglia (Londyn), Szwajcaria, USA (Nowy Orlean), Szkocja, 1894 rok",
    description:
  ...
  "Persona 3 Reload": {
    ...
    why: "Wysteria odpowiada za motyw ukrytej rzeczywistości, masek i alternatywnego świata (Dark Hour). Aquila natomiast symbolizuje przeznaczenie, cykl życia i śmierci oraz kosmiczny porządek reprezentowany przez Nyx oraz wiele odniesień do mitologii greckiej. Persona 3 jest w zasadzie swego rodzaju dramatem greckim. Ta gra idealnie łączy psychologię z metafizyką.",
    protagonist: "Makoto Yuki, SEES",
    antagonist: "Shuji Ikutsuki, Strega, Nyx",
    location: "Japonia (Tatsumi Port Island), 2009-2010 rok",
    description:
  ...
  "Persona 3 Portable": {
    world: "Wysteria, Aquila",
    why: "Możliwość wyboru protagonisty i silny nacisk na relacje podkreślają osobistą interpretację rzeczywistości – kluczowy motyw Wysterii. Jednocześnie nieuchronność losu, nadciągającej katastrofy i odniesienia do mitologii greckiej mocno wiąże grę z Aquilą jako światem kosmicznego przeznaczenia.",
    protagonist: "Makoto Yuki / Kotone Shiomi, SEES",
    antagonist: "Shuji Ikutsuki, Strega, Nyx",
    location: "Japonia (Tatsumi Port Island, Tartarus), 2009-2010 rok",
    description:
  ...
  "Persona 3 Dancing in The Moonlight": {
    world: "Wysteria, Aquila",
    why: "Choć to lżejszy spin-off, nadal funkcjonuje jako „iluzja pomiędzy światami” – senna, symboliczna przestrzeń oderwana od głównej fabuły. Wysteria odpowiada za tę nierealność, a Aquila za motyw księżyca, rytmu czasu i kosmicznej harmonii.",
    protagonist: "SEES",
    antagonist: "-",
  ...
  "Persona 4 Golden": {
    world: "Wysteria",
    why: "Wysteria to świat iluzji, masek i rywalizujących interpretacji prawdy. Persona 4 Golden opiera się dokładnie na tych motywach: miasteczko Inaba jest spokojne tylko pozornie, a prawda ukrywa się za społecznymi rolami i wyparciem. Telewizyjny świat cieni działa jak wysteriańska projekcja psychiki – miejsce, gdzie wewnętrzne konflikty przybierają realną formę.",
    protagonist: "Yu Narukami, Investigation Team",
    antagonist: "Morderca (Tohru Adachi)",
    location: "Japonia (Inaba), TV World, 2011-2012 rok",
    description:
  ...
  "Persona 4 Arena Ultimax": {
    world: "Wysteria",
    why: "Bezpośrednie starcia 1v1 są tu symbolicznym konfliktem tożsamości i idei. Wysteria pasuje jako świat, w którym iluzje materializują się w formie pojedynków, a granica między „prawdą” a „fałszem” zostaje całkowicie zatarta. Hi-no-Kagutsuchi działa jak wysteriański byt karmiący się chaosem i sprzecznymi narracjami.",
    protagonist: "SEES, Investigation Team",
    antagonist: "Hi‑no‑Kagutsuchi",
    location: "Japonia (Inaba), TV World, 2012 rok",
    description:
  ...
  "Persona 4 Dancing all Night": {
    world: "Wysteria",
    why: "Muzyczny spin-off funkcjonuje jak sen lub alternatywna projekcja – oderwana od logiki, lecz pełna emocjonalnej prawdy. Wysteria idealnie obejmuje takie „międzyświaty”, gdzie postacie wyrażają siebie poprzez symbol, ruch i estetykę zamiast konfliktu.",
  ...
  "Persona 5 Royal": {
    ...
    why: "Wysteria – Metaverse jako dziwny świat iluzji i masek. Szczególnie dziwne Muzeum Madarame. Avalon – średniowieczny Pałac Kamoshidy, motyw buntu, idealizmu i rycerskiej walki o sprawiedliwość. Marleybone –  skorumpowane miasta, władza, polityka i system oraz Bank Kaneshiro. Krokotopia – Egipska piramida w Pałacu Futaby. Celestia – manipulacja poznaniem, Yaldabaoth jako fałszywy porządek, a także kosmiczny pałac Okumury. Dragonspyre – eskalacja konfliktu w otwartą wojnę ideologiczną i bliski koniec świata. Persona 5 Royal to pełna Spiralna podróż przez różne oblicza władzy i kontroli.",
    protagonist: "Ren Amamiya (Joker), Phantom Thieves",
    antagonist: "Masayoshi Shido, Takuto Maruki, Yaldabaoth, Goro Akechi",
    location: "Japonia (Tokio), Metaverse, czasy współczesne",
    description:
  ...
  "Persona 5 Strikers": {
    ...
    why: "Wysteria – powrót do fundamentów i relacji. Wizard City - Więzienie Shibuya. Avalon - Średniowieczne więzienie Sendai. Polaris - Mroźne więzienie Sapporo. Mooshu – feudalnojapońskie więzienie Kyoto. Marleybone – wielkomiejskie scenerie. Celestia - Duże znaczenie AI i więzienie Osaka & Dragonspyre – eskalacja technologii w zagrożenie świata. Gra przypomina pełnoprawną wyprawę przez Spiralę.",
    protagonist: "Ren Amamiya (Joker), Phantom Thieves",
  ...
  "Persona 5 Tactica": {
    ...
    why: "Polaris - królestwo Marie (porządek, opresja, rewolucja), Mooshu - królestwo Yoshiki (dyscyplina i strategia, feudalna Japonia), Marleybone - gangsterskie motywy Repaint Your Heart DLC, Dragonspyre (otwarty konflikt). Wysteria spina to jako świat ideologicznej wojny symboli.",
    protagonist: "Ren Amamiya (Joker), Phantom Thieves",
  ...
  "Persona 5 The Phantom X": {
    world: "Wysteria",
    why: "Nowy protagonista i alternatywna narracja to klasyczny wysteriański zabieg: ta sama idea, inna interpretacja. Gra eksploruje pytanie, kim jest Złodziej Serc, gdy zmienia się perspektywa i kontekst.",
  ...
  "Persona 5 Dancing in The Starlight": {
    world: "Wysteria",
    why: "Taneczny świat działa jak iluzoryczna celebracja emocji po konflikcie. Wysteria obejmuje przestrzenie „poza czasem”, gdzie postacie istnieją jako symbole więzi, a nie narzędzia walki.",
  ...
  "Persona Q": {
    world: "Wysteria",
    why: "Labirynty Persona Q są czystą manifestacją Wysterii: sztuczne, symboliczne światy stworzone z fragmentów cudzych umysłów. Clockwork God działa jak byt porządkujący iluzję – fałszywy architekt rzeczywistości.",
    protagonist: "SEES, Investigation Team",
    antagonist: "Clockwork God",
    location: "Zachwiany czas i przestrzeń",
    description:
  ...
  "Persona Q2": {
    world: "Wysteria",
    why: "Motyw kina, narracji i ról społecznych jeszcze mocniej zakotwicza grę w Wysterii. Enlil jako obserwator i manipulator historii pasuje do świata, w którym rzeczywistość jest sceną, a bohaterowie – aktorami walczącymi o własny głos.",
  ...
  "Epoka Lodowcowa 3": {
    ...
    why: "Polaris reprezentuje epokę lodu, surowy klimat i walkę o przetrwanie w zamarzniętym świecie — dokładnie to, od czego zaczyna się gra. Azteca odpowiada podziemnemu światu dinozaurów: dzikiemu, pierwotnemu, rządzonemu przez instynkt i siłę. Połączenie tych światów oddaje kontrast między lodową powierzchnią a prehistoryczną dżunglą pod nią.",
    protagonist: "Sid, Buck, Scrat",
    antagonist: "Rudy, dinozaury",
    location:
      "Prehistoryczna Ziemia Epoki Lodowcowej i świat dinozaurów pod nią",
    description:
  ...
  "Dante's Inferno": {
    world: "Dragonspyre",
    why: "Dragonspyre to świat upadku, ruin i wojny prowadzonej aż do zatracenia. Podobnie jak Piekło w Dante’s Inferno, jest miejscem spopielonym przez grzech, pychę i ambicję. Dziewięć kręgów Piekła odpowiada kolejnym warstwom zniszczenia i moralnego zepsucia — dokładnie temu, czym Dragonspyre stało się po własnej katastrofie.",
    protagonist: "Dante",
    antagonist: "Lucyfer, demony z Piekła",
    location: "Piekło, 1191 rok",
    description:
  ...
  Madagaskar: {
    world: "Zafaria",
    why: "Zafaria to żyjący, barwny świat zwierząt, plemiennych społeczności i naturalnej harmonii (lub jej braku). Gra Madagaskar opiera się na tej samej energii: dżungla, fauna, hierarchie zwierzęce i humor wynikający z różnic charakterów. Król Foss pasuje do motywu lokalnych „władców” Zafarii.",
    protagonist: "Alex, Marty, Gloria, Melman",
    antagonist: "Król Foss",
    location: "USA (ZOO w Central Parku), Madagaskar, 2005 rok",
    description:
  ...
  "Madagaskar 2": {
    world: "Zafaria",
    why: "Druga część jeszcze mocniej eksploruje konflikty wewnątrz zwierzęcych społeczności. Makunga jako antagonista idealnie wpisuje się w zafariową narrację walki o przywództwo, dumę i tożsamość stada. To świat, gdzie siła charakteru liczy się bardziej niż technologia.",
    protagonist: "Alex, Marty, Gloria, Melman",
    antagonist: "Makunga",
    location: "Madagaskar, Afryka, krótko po 2005 roku",
    description:
  ...
  "Spooky's Jumpscare Mansion": {
    world: "Darkmoor",
    why: "Darkmoor to królestwo groteskowego horroru, duchów i spaczonej zabawy strachem. Spooky idealnie pasuje jako „niewinna” maska dla czystego koszmaru — dokładnie tak, jak Darkmoor łączy humor z czarną magią. Rezydencja działa jak darkmoorowy loch: absurdalny, ale śmiertelnie niebezpieczny.",
    protagonist: "Gracz",
    antagonist: "Spooky, Specimen",
    location: "Rezydencja Spooky, czasy współczesne",
    description:
  ...
  "Metal Gear Rising Revengeance": {
    world: "Celestia",
    why: "Celestia to świat zaawansowanej wiedzy, technologii i idei, które wymknęły się spod kontroli. Metal Gear Rising eksploruje te same pytania: gdzie kończy się człowiek, a zaczyna broń? Armstrong i systemy wojny informacyjnej działają jak celestyjskie artefakty — potężne, ale moralnie niebezpieczne.",
    protagonist: "Raiden",
    antagonist: "Senator Steven Armstrong, Samuel Rodrigues (Jetstream Sam)",
    location: "USA, państwa postradzieckie, Pakistan, 2018 rok",
    description:
  ...
  "Sphinx and The Cursed Mummy": {
    world: "Krokotopia",
    why: "Krokotopia jest światem starożytnej magii, zapomnianych bogów i pustynnych ruin. Set jako antagonista jest niemal dosłownym odpowiednikiem krokotopiańskich bóstw chaosu. Gra opiera się na eksploracji piramid, zagadkach i mitologii — dokładnie tym, czym Krokotopia stoi.",
  ...
  "Buckshot Roulette": {
    world: "Darkmoor",
    why: "Psychologiczny horror, napięcie, gra z losem i poczucie nieuchronnej śmierci — Darkmoor to idealne tło. Brak jasnych zasad i ciągłe poczucie zagrożenia pasują do darkmoorowej filozofii: strach jako forma rozrywki i kontroli.",
    protagonist: "Gracz",
    antagonist: "Przeciwnik",
    location: "Klub Nocny, 1998 rok",
    description:
  ...
  Raft: {
    world: "Celestia",
    why: "Celestia reprezentuje świat oceanu, ruin dawnej cywilizacji i walki o przetrwanie po katastrofie. Raft idealnie oddaje ten klimat: dryfowanie po pozostałościach świata, odkrywanie technologicznych sekretów i samotność na otwartym morzu wiedzy, która przetrwała upadek ludzkości.",
    protagonist: "Ocalały",
    antagonist: "Olof Wilkstrom",
    location: "Zatopiona Ziemia, niedaleka przyszłość",
    description:
  ...
  "Kung Fu Panda": {
    world: "Mooshu",
    why: "Mooshu to świat honoru, mistrzów sztuk walki, duchowej równowagi i dyscypliny. Historia Po doskonale wpisuje się w mooshuowy motyw „ucznia, który musi odnaleźć drogę”. Tai Lung reprezentuje wypaczenie tej filozofii — siłę bez harmonii.",
    protagonist: "Po",
    antagonist: "Tai Lung",
    location: "Starożytne Chiny (Dolina Spokoju)",
    description:
  ...
  "Duke Dashington": {
    ...
    why: "Azteca – świątynia aztecka. Krokotopia – starożytna piramida egipska. Aquila – starożytna zatopiona świątynia grecka. Dragonspyre - wnętrze wulkanu. Khrysalis – kryształowa grota. To czysta esencja „uciekaj albo zgiń”, pasująca do tych światów.",
    protagonist: "Duke Dashington",
    antagonist: "-",
    location: "Egipt, Ameryka, Atlantyda, Wulkan, Grota",
    description:
  ...
  "Spongebob Battle for Bikini Bottom": {
    world: "Celestia",
    why: "Celestia to podwodny świat starożytnej technologii i ruin. Bikini Bottom działa podobnie: zaawansowana (absurdalnie) cywilizacja pod wodą, roboty Planktona jako odpowiednik niekontrolowanej technologii Celestii oraz lekki ton maskujący realne zagrożenie.",
    protagonist: "SpongeBob",
    antagonist: "Plankton, roboty",
    location: "Bikini Dolne, czasy współczesne",
    description:
  ...
  "Game Of Thrones Telltale": {
    ...
    why: "Avalon – średniowieczna rycerskość, honor, zdrady i polityka rodów Westeros. Grizzleheim – brutalność i chłód terenów za Murem i bezpośrednio przy nim. Krokotopia – stare prawa, tradycja i niezmienny porządek w Essos. Gra skupia się na decyzjach moralnych i konsekwencjach — dokładnie tym żyją te światy.",
    protagonist: "Rodzina Forresterów",
    antagonist: "Lord Ludd Whitehill",
    location: "Westeros, Essos, 299-300 o.P. (od Podboju Aegona)",
    description:
  ...
  "Game Of Thrones RPG": {
    ...
    why: "Avalon reprezentuje feudalne konflikty i rycerskie ideały, a Grizzleheim surową rzeczywistość wojny i życie w zimnych krainach przy Murze. RPG-owa struktura, rozwój postaci i polityczne wybory idealnie pasują do tej osi: honor kontra brutalne przetrwanie.",
    protagonist: "Mors Westford, Alester Sarwyck",
    antagonist: "Valarr Hill",
    location: "Westeros, 298 o.P. (od Podboju Aegona)",
    description:
  ...
  Cuphead: {
    world: "Marleybone",
    why: "Marleybone to świat stylu, maski i elegancji skrywającej chaos. Cuphead działa identycznie: kreskówkowa estetyka przykrywa piekielnie trudną rozgrywkę, a kontrakty z diabłem pasują do marleybońskiej ironii i społecznej satyry.",
    protagonist: "Cuphead, Mugman",
    antagonist: "Diabeł, Król Kości, Szef Solniczka",
    location: "Wyspy Inkwell, Kasyno Diabła",
    description:
  ...
  Hercules: {
    world: "Aquila",
    why: "Aquila to świat mitologii, herosów i prób godnych półbogów. Herkules przechodzi klasyczną drogę bohatera: od wygnania, przez próby, aż po konfrontację z bogiem podziemi. To niemal 1:1 filozofia Aquili.",
  ...
  "Call of Duty World War 2": {
    world: "Polaris, Dragonspyre",
    why: "Polaris – wojna totalna, okupacja, zimny konflikt. Dragonspyre – zniszczenie, ruiny, cena ambicji i ideologii. Gra pokazuje świat pożarty przez konflikt, dokładnie jak Dragonspyre po własnym upadku.",
    protagonist: "Ronald 'Red' Daniels",
    antagonist: "SS‑Hauptsturmführer Metz, naziści",
    location: "Europa, front zachodni, 1944-1945 rok",
    description:
  ...
  "Age of Empires": {
    ...
    why: "Krokotopia – Starożytny Egipt. Aquila - Starożytna Grecja. / Mooshu - Japonia. Azteca – Babilonia. Dragonspyre – Rzym. Wysteria – Rzym. RTS idealnie oddaje rozwój, konflikt i ekspansję cywilizacji.",
    protagonist: "Różne frakcje",
    antagonist: "Różne frakcje",
    location:
      "Starożytne/Średniowieczne Egipt, Grecja, Babilonia, Rzym, Japonia",
    description:
  ...
  Helltaker: {
    world: "Dragonspyre",
    why: "Dragonspyre to świat obsesji, pychy i zejścia do piekła wiedzy. Helltaker przedstawia piekło w krzywym zwierciadle — humorystycznie, ale nadal jako miejsce pokusy, ambicji i konsekwencji.",
    protagonist: "Helltaker",
    antagonist: "Lucifer, Azazel, Beelzebub",
    location: "Piekło, czasy współczesne",
    description:
  ...
  "The Binding Of Isaac": {
    ...
    why: "Darkmoor – psychologiczny horror, trauma, religijne wypaczenie, nawiedzony dom. Dragonspyre – kara, ogień, piekielna symbolika. Isaac to podróż przez wewnętrzne piekło dziecka, dokładnie to, czym te światy stoją.",
    protagonist: "Isaac",
    antagonist: "Matka, Szatan",
    location:
      "Dom na wzgórzu, piwnica, grota, sheol, katedra, wyobraźnia Isaaca, czasy współczesne",
    description:
  ...
  "Squid Game Bez Pardonu": {
    world: "Wysteria",
    why: "Wysteria to świat rywalizacji, testów i fałszywej „akademickiej” uczciwości. Squid Game zamienia gry w egzaminy życia i śmierci — dokładnie ten sam motyw, tylko bez maski grzeczności.",
    protagonist: "Gracz",
    antagonist: "Organizator, rywalizujący gracze",
    location: "Korea Południowa (Wyspa gier), współczesność",
    description:
  ...
  Aladyn: {
    world: "Zafaria",
    why: "Zafaria łączy egzotykę, pustynie i baśniowy klimat. Aladyn pasuje idealnie: spryt zamiast siły, magia dżina i walka z tyranią w świecie bazarów i pałaców.",
    protagonist: "Aladyn",
    antagonist: "Dżafar",
    location: "Agrabah",
    description:
  ...
  "Król Lew": {
    world: "Zafaria",
    why: "Zafaria to naturalny porządek, krąg życia i walka o przywództwo. Historia Simby idealnie oddaje ten motyw: dorastanie, strata, odpowiedzialność i odzyskanie równowagi w świecie zwierząt.",
    protagonist: "Simba",
    antagonist: "Skaza",
    location: "Afryka (Safari)",
    description:
  ...
  "Black Myth: Wukong": {
    world: "Mooshu",
    why: "Mooshu jest światem inspirowanym mitologią i filozofią Dalekiego Wschodu: bogowie, demony i duchy, droga samodoskonalenia i przeznaczenia, walka między porządkiem a chaosem. Historia Przeznaczonego to klasyczna podróż duchowa wojownika, dokładnie taka, jaką reprezentuje Mooshu.",
  ...
  "Total War: Three Kingdoms": {
    world: "Mooshu",
    why: "Mooshu doskonale oddaje epokę Trzech Królestw: honor generałów, zdrady polityczne, balans między strategią a filozofią wojny. Gra skupia się na tym samym konflikcie idei, lojalności i ambicji, który definiuje Mooshu.",
    protagonist: "Gracz",
  ...
  "The Legend Of Zelda: Breath of The Wild": {
    world: "Avalon, Celestia, Mooshu, Azteca, Krokotopia, Dragonspyre",
    why: "Avalon – legenda, rycerstwo, przeznaczenie bohatera. Celestia – ruiny pradawnej cywilizacji, zapomniana technologia. Mooshu - tereny inspirowane Feudalną Japonią. Azteca - wioska Ptaków. Krokotopia - pustynne regiony. Dragonspyre - wulkan i okolice pełne ognia i lawy. Hyrule po katastrofie to świat odkrywany przez relikty przeszłości i mit, dokładnie jak połączenie Avalonu i Celestii.",
    protagonist: "Link",
    antagonist: "Calamity Ganon",
    location:
      "Hyrule, wiele tysięcy lat po większości gier The Legend of Zelda",
    description:
  ...
  "Hyrule Warriors: Age Of Calamity": {
    ...
    why: "Gra przedstawia wojnę totalną przed upadkiem cywilizacji: Avalon – heroiczna obrona królestwa. Celestia – technologia Strażników i Boskich Bestii. Masowe bitwy i epicka skala idealnie pasują do tych światów.",
  ...
  "The Legend Of Zelda: Tears of Kingdom": {
    world: "Avalon, Celestia",
    why: "Rozszerzenie świata w górę i w dół: Avalon – legenda bohatera i wieczna walka dobra ze złem. Celestia – starożytne konstrukcje, niebo i technologia Zonai. Gra eksploruje spuściznę dawnych cywilizacji, dokładnie jak Celestia.",
    protagonist: "Link",
  ...
  "Hyrule Warriors: Age of Imprisonment": {
    world: "Avalon, Celestia",
    why: "Alternatywna linia czasu podkreśla: Avalon – los, który można zmienić tylko heroicznym poświęceniem. Celestia – konsekwencje ingerencji w pradawną moc. To wariacja mitu, nie jego zaprzeczenie — bardzo „avalonowa”.",
  ...
  "Super Mario Odyssey": {
    ...
    why: "nauka i eksperyment (Wizard City), ruiny i starożytność (Krokotopia, Azteca), industrialne miasta (Marleybone), kultura i filozofia (Mooshu), ogień i chaos (Dragonspyre), niebo i podróż (Celestia, Polaris), presja czasu i zagłada (Khrysalis). To niemal modelowa „gra-Spirala”.",
    protagonist: "Mario",
    antagonist: "Bowser",
    location: "Królestwa Ziemi (W tym Grzybowe Królestwo), Księżyc",
    description:
  ...
  "Luigi's Mansion 3": {
    world: "Darkmoor",
    why: "Darkmoor to świat duchów, klątw i nawiedzonych miejsc. Luigi eksploruje dokładnie taki obszar: zamknięty, mroczny, pełen zjaw i sekretów, ale z cieniem humoru, który nie łamie grozy.",
    protagonist: "Luigi",
    antagonist: "King Boo",
  ...
  "Super Mario RPG": {
    world: "Wizard City",
    why: "Wizard City to miejsce, gdzie magia spotyka naukę. Smithy reprezentuje chaotyczną, sztuczną magię maszyn, a drużynowe RPG-owe podejście, rozwój umiejętności i eksperymentowanie idealnie wpisują się w akademicki charakter tego świata.",
    protagonist: "Mario",
    antagonist: "Smithy",
    location: "Grzybowe Królestwo",
    description:
  ...
  "Devil May Cry": {
    world: "Dragonspyre, Darkmoor",
    why: "Dragonspyre odpowiada piekielnemu, zniszczonemu światu demonów, ruin i wiecznej wojny, gdzie liczy się siła, styl walki i dominacja mocy. Darkmoor uzupełnia to o gotycki horror, przeklęte posiadłości i obecność potężnych bytów z innego wymiaru, idealnie pasujących do demonicznej genezy Mundusa i mrocznej atmosfery gry.",
    protagonist: "Dante",
    antagonist: "Mundus",
    location: "Temen-Ni-Gru, współczesność",
    description:
  ...
  "Devil May Cry 2": {
    world: "Dragonspyre",
    why: "Dragonspyre jako świat upadłych imperiów i obsesji na punkcie potęgi doskonale pasuje do historii Ariusa i jego dążeń do boskiej władzy. Surowe, wypalone krajobrazy odzwierciedlają chłodniejszy ton gry oraz dystans Dantego wobec świata i konfliktu.",
    protagonist: "Dante",
    antagonist: "Arius",
    location: "Wyspa Dumary Island, współczesność",
    description:
  ...
  "Devil May Cry 3": {
    world: "Dragonspyre",
    why: "Dragonspyre symbolizuje pierwotny konflikt, ogień ambicji i destrukcyjną rywalizację – dokładnie to, co napędza starcie Dantego i Vergila. To świat, w którym rodzą się legendy poprzez walkę, a moc i ambicja są ważniejsze niż moralność.",
    protagonist: "Dante",
    antagonist: "Vergil, Arkham",
    location: "Mallet Island, współczesność",
    description:
  ...
  "Devil May Cry 4": {
    world: "Dragonspyre",
    why: "Dragonspyre pasuje do motywu fanatyzmu religijnego i wypaczonej wiary w „boską moc”. Kult Sanctusa i jego demoniczne rytuały są naturalnym przedłużeniem świata, w którym smoki, ogień i obsesja kontroli doprowadziły cywilizację do upadku.",
    protagonist: "Nero",
    antagonist: "Sanctus",
    location: "Miasto Fortuna, współczesność",
    description:
  ...
  "DMC Devil May Cry": {
    world: "Dragonspyre",
    why: "Dragonspyre reprezentuje brutalny, zbuntowany świat rządzony siłą i tyranią, co idealnie współgra z anarchicznym tonem rebootu. To rzeczywistość, w której demony rządzą zza kulis, a bunt i przemoc są jedyną odpowiedzią na opresję.",
    protagonist: "Dante",
    antagonist: "Mundus",
    location: "Limbo City, współczesność",
    description:
  ...
  "Devil May Cry 5": {
    world: "Dragonspyre",
    why: "Dragonspyre jest światem ostatecznego starcia potęg i konsekwencji dawnych grzechów. Powrót Vergila, motyw drzewa Qliphoth i walka o granice własnej mocy idealnie pasują do krainy, gdzie historia zawsze kończy się ogniem, ruiną i legendą",
    protagonist: "Dante, Nero, V",
    antagonist: "Vergil",
    location: "Red Grave City, współczesność",
    description:
  ...
  "Clair Obscur Expedition 33": {
    ...
    why: "Wysteria oddaje surrealizm, iluzję i emocjonalną niepewność świata gry, Celestia – abstrakcyjne idee losu i transcendencji, Khrysalis – motyw przemiany i cykliczności istnienia, a Dragonspyre – ukrytą grozę i destrukcyjne konsekwencje twórczej obsesji Malarki. Razem tworzą świat symboli, a nie jednej rzeczywistości.",
    protagonist: "Gustave, Ekspedycja 33",
    antagonist: "Malarka",
    location: "Lumiere, Kontynent, 67 lat od Rozłamu",
    description:
  ...
  "Slay The Princess": {
    world: "Darkmoor",
    why: "Darkmoor idealnie oddaje psychologiczny horror, manipulację i niepewność prawdy. To świat, w którym rzeczywistość zmienia się w zależności od wyborów, a zaufanie do narratora jest tak niebezpieczne, jak sama księżniczka.",
    protagonist: "Gracz",
  ...
  Gujian: {
    world: "Mooshu",
    why: "Mooshu to świat harmonii, duchów i tradycji wuxia, gdzie honor, przeznaczenie i relacja między ludźmi a nadnaturalnym są fundamentem narracji. Idealnie odzwierciedla mitologiczną strukturę Gujian.",
    protagonist: "Baili Tusu",
    antagonist: "Ouyang Shaogong",
    location: "Mitologia chińska",
    description:
  ...
  "Gujian 2": {
    world: "Mooshu",
    why: "Mooshu podkreśla konflikt między nowoczesnością a tradycją oraz napięcie między duchami a ludźmi. Świat ten sprzyja opowieściom o zaufaniu, zdradzie i delikatnej równowadze moralnej.",
  ...
  "Gujian 3": {
    world: "Mooshu",
    why: "Mooshu jako żyjący, mistyczny świat idealnie pasuje do otwartej struktury gry, legendarnych bestii i moralnych wyborów Beiluo. To kraina, gdzie mit i rzeczywistość przenikają się naturalnie.",
    protagonist: "Beiluo",
    antagonist: "Wuzhao",
    location: "Mitologia chińska",
    description:
  ...
  "Where Winds Meet": {
    world: "Mooshu",
    why: "Mooshu reprezentuje wolność wędrówki, mistrzów miecza i filozofię wuxia. Świat ten pozwala na istnienie zarówno honorowych bohaterów, jak i samotnych awanturników, dokładnie jak w strukturze gry.",
    protagonist: "Wędrowiec / młody mistrz miecza",
    antagonist: "Rozliczni przeciwnicy i siły chaosu",
    location: "Starożytne Chiny, X wiek",
    description:
  ...
  "Wuchang Fallen Feathers": {
    world: "Mooshu",
    why: "Mooshu w swojej mroczniejszej, wypaczonej formie pasuje do świata dotkniętego plagą, demonami i upadkiem duchowej harmonii. Feathering jest zaprzeczeniem równowagi Mooshu, czyniąc z tej krainy miejsce tragedii i degeneracji.",
    protagonist: "Bai Wuchang",
    antagonist: "Xuanyangzi i demoniczne moce Feathering",
    location: "Chiny za czasów dynastii Ming",
    description:
  ...
  Wizard101: {
    ...
    protagonist: "Młody Czarodziej",
    antagonist: "Malistaire Drake, Morganthe, Grandfather Spider",
    location: "Świat Spirali",
    description:
      "Magiczne MMO stworzone przez KingsIsle Entertainment, w którym wcielasz się w ucznia Ravenwood School of Magical Arts. Podróżujesz przez światy Spiral, uczysz się szkół magii (Fire, Ice, Storm, Myth, Life, Death, Balance), zbierasz zaklęcia i walczysz w turowym systemie opartym na kartach. Historia zaczyna się od konfliktu z Malistaire’em, ale z czasem przeradza się w kosmiczną sagę o naturze magii i równowadze całego istnienia.",
  },

  Minecraft: {
    why: "Minecraft to jedna z dwóch gier, które mnie ukształtowały. Jest to gra bardzo prosta. Ale w swojej prostocie jest wybitna. Daje nieograniczone możliwości, pobudza kreatywność i myślę że - w moim przypadku - również wrażliwość. Na dzień dzisiejszy Minecraft mi się znudził... Zwykłam mówić, że nie lubię Minecrafta, ale uważam że to najlepsza gra jaka powstała. Zasługuje na tło w sekcji o serialach, mimo że serialem nie jest. Nie będę przypisywać Minecraftowi kategorii każdego świata, bo spełniałby wszystkie kryteria, a Minecraft to kryterium samo w sobie.",
    protagonist: "Steve / Alex",
    antagonist: "Ender Dragon, Wither, Creepery, Illagerzy, inni gracze",
    location: "Overworld, Nether, End",
    description:
  ...
  Pirate101: {
    world:
      "Marleybone, Mooshu, Aquila, Avalon, Azteca, Wysteria, Dragonspyre, Wizard101",
    why: "Marleybone, Mooshu, Aquila i Dragonspyre pojawiają się we własnej osobie, Monquista i Valencia pod względem średniowiecznych motywów europejskich przypominają Avalon, architekturą śródziemnomorską zaś - Wysterię. Jest też obecny teren Aztecozaurów, chociaż nie jest to Azteca sama w sobie. Jest to ten sam świat co Wizard101.",
